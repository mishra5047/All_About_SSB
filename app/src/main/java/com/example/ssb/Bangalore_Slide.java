...
public class Bangalore_Slide extends Activity {
    ...
    List<Model> models;
    CircularImageView maps_open,btn_speech;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhopal__slide);
        btn_speech = (CircularImageView) findViewById(R.id.audio_btn_bhopal);
        maps_open = (CircularImageView) findViewById(R.id.maps_button_bhopal);
